...
// === ClientScorecard.jsx ===
// Using simple ASCII only - no unicode escapes
const scorecard = [
...
fs.writeFileSync("src/pages/ClientScorecard.jsx", scorecard, "utf8");
console.log("Created src/pages/ClientScorecard.jsx (clean)");